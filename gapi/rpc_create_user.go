...
func (server *Server) CreateUser(ctx context.Context, req *backendproduction_2.CreateUserRequest) (*backendproduction_2.CreateUserResponse, error) {
	...
	rsp := &backendproduction_2.CreateUserResponse{
		User: convertUser(user),
	}
	return rsp, nil
}

func validateCreateUserRequest(req *backendproduction_2.CreateUserRequest) (violations []*errdetails.BadRequest_FieldViolation) {
